...
while True:
    for event in pg.event.get():
        ...
        if event.type == pg.KEYDOWN:
            if event.key == pg.K_LEFT and last_direction != 'right':
                x_change -= snake_part
                y_change = 0
                last_direction = 'left'
            elif event.key == pg.K_RIGHT and last_direction != 'left':
                x_change = snake_part
                y_change = 0
                last_direction = 'right'
            elif event.key == pg.K_UP and last_direction != 'down':
                x_change = 0
                y_change -= snake_part
                last_direction = 'up'
            elif event.key == pg.K_DOWN and last_direction != 'up':
                x_change = 0
                y_change = snake_part
                last_direction = 'down'
